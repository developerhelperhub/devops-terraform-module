...
module "devops" {
  ...
  jenkins_maven_config_enabled = false
  jenkins_maven_config_pvc_storage_size = "10Gi"
  jenkins_maven_config_pv_storage_size = "5Gi"
  jenkins_maven_config_pv_storage_source_host_path = "/mnt/data/jenkins/maven-repo"
